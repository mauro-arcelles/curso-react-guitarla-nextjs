...
export async function getStaticProps({ params }) {
  const res = await fetch(`${process.env.API_URL}/guitarras?filters[url]=${params.url}&populate=imagen`);
...
//   const res = await fetch(`${process.env.API_URL}/guitarras?filters[url]=${query.url}&populate=imagen`);
//   const { data: guitarra } = await res.json();
//   console.log(guitarra);
//   return {
//     props: {
